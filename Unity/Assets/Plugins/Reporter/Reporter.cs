...
public class Reporter : MonoBehaviour
{
	...
	public void Initialize()
	{
        ...
        showCopyButton = (PlayerPrefs.GetInt("Reporter_showCopyButton", 0) == 1) ? true : false;
        showCopyAllButton = (PlayerPrefs.GetInt("Reporter_showCopyAllButton", 0) == 1) ? true : false;
        showSaveButton = (PlayerPrefs.GetInt("Reporter_showSaveButton", 0) == 1) ? true : false;
	...
	{
		Log log = new Log() { condition = $"[{DateTime.Now.ToLongTimeString()}] {condition}", stacktrace = stacktrace, logType = (_LogType)type };
		lock (threadedLogs) {
